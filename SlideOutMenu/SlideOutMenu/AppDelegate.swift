...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
    ...
    tabBarController.setViewControllers([
      UINavigationController(rootViewController: FirstViewController(appDelegate: self)),
      UINavigationController(rootViewController: SecondViewController())
      ], animated: false)
    
    let menu = UIViewController()
    menu.view.backgroundColor = .yellow
    mainAppVC = MainAppViewController(sideMenu: menu, mainContent: tabBarController)
